...
item(_MATE_PANEL_ACTION_SWITCH_TO_WINDOW_LIST_1)
item(_MATE_PANEL_ACTION_SWITCH_TO_WINDOW_LIST_2)
item(_MATE_PANEL_ACTION_SWITCH_TO_WINDOW_LIST_3)
item(_MATE_PANEL_ACTION_SWITCH_TO_WINDOW_LIST_4)
item(_MATE_PANEL_ACTION_SWITCH_TO_WINDOW_LIST_5)
item(_MATE_PANEL_ACTION_SWITCH_TO_WINDOW_LIST_6)
item(_MATE_PANEL_ACTION_SWITCH_TO_WINDOW_LIST_7)
item(_MATE_PANEL_ACTION_SWITCH_TO_WINDOW_LIST_8)
item(_MATE_PANEL_ACTION_SWITCH_TO_WINDOW_LIST_9)
item(_MATE_PANEL_ACTION_SWITCH_TO_WINDOW_LIST_0)

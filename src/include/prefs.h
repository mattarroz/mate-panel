...
typedef enum _MetaKeyBindingAction
{
  ...
  META_KEYBINDING_ACTION_SWITCH_TO_WINDOW_LIST_1,
  META_KEYBINDING_ACTION_SWITCH_TO_WINDOW_LIST_2,
  META_KEYBINDING_ACTION_SWITCH_TO_WINDOW_LIST_3,
  META_KEYBINDING_ACTION_SWITCH_TO_WINDOW_LIST_4,
  META_KEYBINDING_ACTION_SWITCH_TO_WINDOW_LIST_5,
  META_KEYBINDING_ACTION_SWITCH_TO_WINDOW_LIST_6,
  META_KEYBINDING_ACTION_SWITCH_TO_WINDOW_LIST_7,
  META_KEYBINDING_ACTION_SWITCH_TO_WINDOW_LIST_8,
  META_KEYBINDING_ACTION_SWITCH_TO_WINDOW_LIST_9,
  META_KEYBINDING_ACTION_SWITCH_TO_WINDOW_LIST_0,
